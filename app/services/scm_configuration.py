...
CAPACIDADES_SCM_INICIALES = (
    ...
    ("OE_VER", "Consultar ordenes de armado"),
    ("OE_LIBERAR", "Liberar ordenes de armado"),
    ("OE_EJECUTAR", "Ejecutar y cerrar ordenes de armado"),
    ("OE_ANULAR", "Anular ordenes de armado"),
