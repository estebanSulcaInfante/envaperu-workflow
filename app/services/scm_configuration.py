...
CAPACIDADES_SCM_INICIALES = (
    ...
    ("OT_ANULAR", "Anular OT de fabricación vacía"),
    ...
    (
        "MANGA_REASIGNAR_MAQUINISTA",
        "Reasignar una manga abierta dentro de la misma OT",
    ),
    (
    ...
    (
        "MANGA_REABRIR",
        "Reabrir una manga cerrada accidentalmente",
    ),
    ...
    (
        ...
        "Registrar apertura tabular excepcional sin pesaje QR",
    ),
    ...
    # Se crea mediante la migración F3, pero no entra al seed general porque
    # GERENTE_GENERAL hereda todo este catálogo. La asignación inicial exige
    # una decisión humana explícita antes del despliegue.
...
ROLES_SCM_INICIALES = (
    ...
    (
        ...
        "Maquinista",
        (
            "OT_VER", "MANGA_PESAR", "MANGA_CONTROL_PESO_REGISTRAR",
            "MANGA_PESAJE_VER", "WIP_VER",
        ),
    ),
    (
        "OPERADOR_MOLINO",
