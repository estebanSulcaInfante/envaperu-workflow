...
def test_kit_sin_color_y_molde_nuevo_sin_composicion_se_rechazan(client):
    ...
    assert kit_sin_color.status_code == 400
    assert kit_sin_color.get_json()['codigo'] == 'KIT_REQUIERE_COLOR'
